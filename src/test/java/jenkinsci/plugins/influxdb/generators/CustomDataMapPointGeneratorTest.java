...
public class CustomDataMapPointGeneratorTest {
    ...
    public void generateTest() {
        ...
        Assert.assertTrue(lineProtocol1.startsWith("series1,project_name=test_prefix_master build_number=11i,test1=11i,test2=22i"));
        Assert.assertTrue(lineProtocol2.startsWith("series2,project_name=test_prefix_master build_number=11i,test3=33i,test4=44i"));
    }
}
